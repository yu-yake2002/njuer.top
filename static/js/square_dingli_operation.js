            ...
            if (DataSender.readyState == 4)
            {
                if (DataSender.status == 200)
                {
                    ...
                    if(document.getElementById("zan_img_hole_" + hid.toString()).alt == "点赞") {
                        ...
                        document.getElementById("zan_img_hole_" + hid.toString()).src = 'static/img/zaned.png?r=3';
                    }else{
                        document.getElementById("zan_img_hole_" + hid.toString()).alt = "点赞";
                        document.getElementById("zan_img_hole_" + hid.toString()).src = 'static/img/flower.png?r=3';
                    }
                }
            }
            return false;
            ...
            if (DataSender.readyState == 4)
            {
                if (DataSender.status == 200)
                {
                    ...
                    if(document.getElementById("zan_img_comments_" + cid.toString()).alt == "点赞") {
                        ...
                        document.getElementById("zan_img_comments_" + cid.toString()).src = 'static/img/zaned.png?r=3';
                    }else{
                        document.getElementById("zan_img_comments_" + cid.toString()).alt = "点赞";
                        document.getElementById("zan_img_comments_" + cid.toString()).src = 'static/img/flower.png?r=3';
                    }
                }
            }
            return false;
