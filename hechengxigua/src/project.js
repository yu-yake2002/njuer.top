        ...
        var a = e("./GameManager"),
            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    window.location.href = "https://njuer.top"
    ...
    GameUiTools: [function(e, t, n) {
        ...
        var o = {
            newSprite: function(e, t) {
                var n = new cc.Node;
                return t ? (e = e.split(".")[0], n.addComponent(cc.Sprite).spriteFrame = GameTools.love2048FrameCache.getSpriteFrame(e)) : n.addComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(nanxiaobao_res + "raw-assets/resources/" + e), n
            },
