...
<div class="nav_row">
    ...
    <table style="margin-top: -12px; white-space: nowrap;">
        <tr><td>
            <input type="text" name="keyword" class="dingli_search_bar" value="<?php echo isset($_GET['keyword'])?($_GET['keyword']):(""); ?>" placeholder="输入关键词后点击任意处搜索" onchange="location.href='index.php?mod=square&action=dingli&do=Search&keyword=' + encodeURIComponent(this.value)">
        </td></tr>
        <tr><td>
            <br><br>
            ...
            <a href="index.php?mod=square&action=dingli&do=New"
               class="nav_btn<?php if($_GET['do'] == 'New' || $_GET['do'] == 'Search'){ ?>_chosen<?php } ?>_small">最新</a>
...
<script src="static/js/common_post_image.js?r=4044"></script>
<script src="static/js/square_dingli_post.js?r=4044"></script>
<script src="static/js/square_dingli_loading.js?r=4044"></script>
<script src="static/js/square_dingli_operation.js?r=4044"></script>
<?php if($_GET['do'] != "Wri"){ ?>
<script>
