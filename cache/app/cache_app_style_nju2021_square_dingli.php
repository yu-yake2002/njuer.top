...
<script src="static/js/common_post_image.js?r=573"></script>
<script src="static/js/square_dingli_post.js?r=573"></script>
<script src="static/js/square_dingli_loading.js?r=573"></script>
<script src="static/js/square_dingli_operation.js?r=573"></script>
<?php if($_GET['do'] != "Wri"){ ?>
<script>
