...
<p align="center" id="loading_hint">正在为您加载更多内容</p>
<?php }else{ ?>
...
<script src="static/js/common_post_image.js?r=3716"></script>
<script src="static/js/square_dingli_post.js?r=3716"></script>
<script src="static/js/day2021/square_dingli_loading.js?r=3716"></script>
<script src="static/js/day2021/square_dingli_operation.js?r=3716"></script>
<?php if($_GET['do'] != "Wri"){ ?>
<script>
