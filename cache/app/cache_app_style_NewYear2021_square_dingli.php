...
<p align="center" style="color: #c30000">左右滑动可以查看更多内容</p>
...
<script src="static/js/common_post_image.js?r=7074"></script>
<script src="static/js/square_dingli_post.js?r=7074"></script>
<script src="static/js/square_dingli_loading.js?r=7074"></script>
<script src="static/js/square_dingli_operation.js?r=7074"></script>
<?php if($_GET['do'] != "Wri"){ ?>
<script>
