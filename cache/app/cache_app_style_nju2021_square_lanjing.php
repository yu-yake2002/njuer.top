...
<?php include template("app_style/nju2021:common:header"); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
<?php include template("app_style/nju2021:square:common_header"); ?>
<div class="nav_row">
...
<?php if($_GET['do'] == 'Message'){ ?>
<script src="static/js/GetMessage.js?r=8274"></script>
<script>
    var ws;
