        ...
        <div class="dingli_text">
            ...
            <div class="like">
                <p align="right" style="padding-right: 6px">
                    ...
                    <img src="static/img/zaned.png?r=3" height="20px" id="zan_img_hole_<?php echo isset($dingli['hid'])?($dingli['hid']):(""); ?>" alt="取消赞"><font color="#793c65"><span id="likes_<?php echo isset($dingli['hid'])?($dingli['hid']):(""); ?>"><?php echo isset($dingli['likes'])?($dingli['likes']):(""); ?></span></font>
                    <?php }else{ ?>
                    <img src="static/img/flower.png?r=3" height="20px" id="zan_img_hole_<?php echo isset($dingli['hid'])?($dingli['hid']):(""); ?>" alt="点赞"><font color="#793c65"><span id="likes_<?php echo isset($dingli['hid'])?($dingli['hid']):(""); ?>"><?php echo isset($dingli['likes'])?($dingli['likes']):(""); ?></span></font>
                    <?php } ?>
                    </a>
                    <img src="static/img/fire.png" height="20px"><font color="#793c65">热度:<?php echo isset($dingli['hot'])?($dingli['hot']):(""); ?></font>
                </p>
            </div>
            ...
            <?php while($comments = db_fetch($comments_query)){ ?>
                ...
                <tr>
                    ...
                    <td align="center" style="vertical-align: bottom; font-size: 12px">
                        <?php if($comments['hide'] != 1){ ?><a href="javascript:zanComment(<?php echo isset($comments['cid'])?($comments['cid']):(""); ?>);"><font color="#793c65">
                        <?php if(db_fetch(db_query("SELECT id FROM square_comments_likes WHERE uid= ".$_G['user']['uid']." AND cid=".$comments['cid']))){ ?>
                        <img src="static/img/zaned.png?r=3" height="20px" id="zan_img_comments_<?php echo isset($comments['cid'])?($comments['cid']):(""); ?>" alt="取消赞">
                        <?php }else{ ?>
                            <img src="static/img/flower.png?r=3" height="20px" id="zan_img_comments_<?php echo isset($comments['cid'])?($comments['cid']):(""); ?>" alt="点赞">
                        <?php } ?><br>
