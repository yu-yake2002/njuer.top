...
<link rel="stylesheet" href="./template_app/style/nju2021/css/square.css?r=4940">
...
<table width="80%" align="center" style="margin: 0 auto" class="footmenu_list">
    <tr>
        <td align="center" width="33%" onclick="location.href='index.php?mod=square&action=dingli&r=<?php echo rand(1,50); ?>';">
            <img src="static/style_img/nju2021/dingli.png?r=4940" class="footmenu_item<?php if($_GET['action'] == 'dingli'){ ?>_chosen<?php } ?>">
        </td>
        <td align="center" width="33%" onclick="location.href='index.php?mod=square&action=match&r=<?php echo rand(1,50); ?>';">
            <img src="static/style_img/nju2021/youyue.png?r=4940" class="footmenu_item<?php if($_GET['action'] == 'match'){ ?>_chosen<?php } ?>">
        ...
        <td align="center" width="33%" onclick="location.href='index.php?mod=square&action=lanjing&r=<?php echo rand(1,50); ?>';">
            <img src="static/style_img/nju2021/lanjing.png?r=4940" class="footmenu_item<?php if($_GET['action'] == 'lanjing'){ ?>_chosen<?php } ?>">
