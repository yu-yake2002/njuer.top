...
<head>
    ...
    <link rel="stylesheet" href="./template_app/style/day2021/css/user_message.css?r=6547">
    <script>
        var message_start = 0;
        var message_stop = 0;
        var message_time = 0;
...
<script src="static/js/common_post_image.js?r=6547"></script>
<script src="static/js/user_message.js?r=6547"></script>
<script>
    var ws;
