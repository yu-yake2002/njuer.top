...
<head>
    ...
    <link rel="stylesheet" href="./template_app/style/NewYear2021/css/user_message.css?r=7774">
    <script>
        var message_start = 0;
        var message_stop = 0;
        var message_time = 0;
...
<script src="static/js/common_post_image.js?r=7774"></script>
<script src="static/js/user_message.js?r=7774"></script>
<script>
    var ws;
